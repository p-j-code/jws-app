...
const EditProfileScreenAuth = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      />
      <InputField label="GSTIN" value={formData.gstin} />
      ...
      <Button
        title="Go Back"
        onPress={navigateToAdminMessage}
        type="text"
        size="sm"
...
export default EditProfileScreenAuth;
